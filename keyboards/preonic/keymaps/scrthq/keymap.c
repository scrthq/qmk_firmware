...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LSPO,        LT(_ADJUST,KC_Z), KC_X,    KC_C,    KC_V,             KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, \
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, RESET,   DEBUG,      _______, _______, _______, _______, KC_KP_4, KC_KP_5, KC_KP_6,   _______, KC_DEL,  \
  KC_CAPS, _______, LCTL(KC_S), _______, _______, _______, _______, KC_KP_1, KC_KP_2, KC_KP_3,   _______, _______, \
  _______, _______, _______,    _______, _______, _______, _______, _______, KC_KP_0, KC_KP_DOT, _______, KC_NLCK, \
  KC_F5,   KC_F8,   KC_APP,     _______, _______, KC_SPC,  KC_SPC,  _______, _______, _______,   _______, _______  \
)
