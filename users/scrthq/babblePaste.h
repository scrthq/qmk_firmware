...
#    ifdef BABL_BROWSER
    ...
    BABL_BROWSER_NUM_LIST,
    BABL_BROWSER_BUL_LIST,
...
#        define B_INDENT BABL_INDENT
#        define B_DEDENT BABL_DEDENT
...
#        define B_NLIST BABL_BROWSER_NUM_LIST
#        define B_BLIST BABL_BROWSER_BUL_LIST
