...
#        ifdef BABL_OSKEYS
    ...
    BABLM(BABL_INDENT, SS_LCTRL("["));
    BABLM(BABL_DEDENT, SS_LCTRL("]"));
    ...
    BABLM(BABL_SCREENCAPTURE, SS_TAP(X_PSCREEN));
...
#        ifdef BABL_BROWSER
    ...
    BABLM(BABL_BROWSER_NUM_LIST, OMSFT(SS_LCTRL("7")));
    BABLM(BABL_BROWSER_BUL_LIST, OMSFT(SS_LCTRL("8")));
