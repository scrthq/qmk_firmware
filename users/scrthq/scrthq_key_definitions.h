...
#if defined(_OSKEY_END)
    #define USER_START _OSKEY_END
#else
...
#define HOLDJBAB   LT(_OSKEYS,KC_J)
#define HOLDS      LT(_SYMBOLS,KC_S)
#define HOLDD      LT(_NUMPAD,KC_D)
#define HOLDLEFT   MT(MOD_HYPR,KC_LEFT)
#define HOLDRIGHT  LCA_T(KC_RIGHT)
#define HOLDMINS   LT(_OSKEYS,KC_MINS)
#define HOLDGUI    LT(_OSKEYS,KC_LGUI)
...
#define MYMEH      MT(MOD_MEH,KC_ESC)
...
#define OS_LDSKTP  HYPR(KC_LEFT)
#define OS_RDSKTP  HYPR(KC_RIGHT)
#define RLDTERM    SGUI(KC_W)
#define RLDWIND    SGUI(KC_R)
#define GOHOME     TO(_QWERTY)
